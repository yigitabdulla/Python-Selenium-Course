...
class TestAddtocart():
  ...
  def test_lowtohigh(self):
    ...
    WebDriverWait(self.driver, 5).until(expected_conditions.visibility_of_element_located((By.CSS_SELECTOR, "*[data-test=\"product_sort_container\"]")))
    self.driver.find_element(By.CSS_SELECTOR, "*[data-test=\"product_sort_container\"]").click()
    WebDriverWait(self.driver, 5).until(expected_conditions.visibility_of_element_located((By.CSS_SELECTOR, "*[data-test=\"product_sort_container\"]")))
    self.driver.save_screenshot(self.folderPath + "/low_to_high.png")
